    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div id="content-wrap">
                <div id="main">				
                    ...
                    <form id="formSubmit" method="post" action="process/processEmpRegister.php">
                        <input type="hidden" name="type" value="SalaryIncrement"/>
            ...
            <table class="tbl">
                ...
                <tr>
                    <td><b>Join Date</b></td>
                    <td><input type="text" class="validate[required]" readonly name="JoinDate" id="JoinDate" value="<?php echo $result[0]['JoinDate'];?>"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b><?php echo $result[0]['CurrentSalary'];?></b></td>
                </tr>
                
                <tr>
                    <td><b>Increment After</b></td>
                    <td>
                ...
                <tr class="temphide">
                    ...
                    <td><b><?php echo $result[0]['LastIncrement']; ?></b></td>
                </tr>
                
                <tr>
                    <td></td>
                    <td><input type="submit" name="submit" id="" value="Salary Update"/></td>
                </tr>
            </table>
            </center>
        </form>
