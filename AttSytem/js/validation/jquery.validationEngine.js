 ...
 */
function checkUsNumber(num,id){
   //  var phone2 = /^(\([0-9]{3}\)[0-9]{3}-[0-9]{4}$)|([0-9]{3}-[0-9]{3}-[0-9]{4}$)/;
   var phone3 = /^[0-9]{10}$/;
   var usNumber = num;
   if (usNumber.match(phone3)){
      var newnum;
      newnum = '('+usNumber.substring(0,3)+')'+usNumber.substring(3,6)+'-'+usNumber.substring(6,10);
      $('#'+id).attr('value', newnum);
   }
   else {}
}

function checkUsNumber1(num,id){
   //  var phone2 = /^(\([0-9]{3}\)[0-9]{3}-[0-9]{4}$)|([0-9]{3}-[0-9]{3}-[0-9]{4}$)/;
   var phone3 = /^[0-9]{10}$/;
   var phone2 = /^(\([0-9]{3}\)[0-9]{3}-[0-9]{4}$)/;
   var p1 = /^(\([0-9]{3}\)[0-9]{3}-[0-9]{2,4}$)/;
   var p2 = /^(\([0-9]{3}\)[0-9]{3}-[0-9]{0,2}$)/;
   var newnum;
   var usNumber = num;
   if (usNumber.match(phone3)){    
      newnum = '('+usNumber.substring(0,3)+')'+usNumber.substring(3,6)+'-'+usNumber.substring(6,10);
      ...
      newnum = usNumber.substring(0,13);
      if (newnum.match(phone2)){
         $('#'+id).attr('value', newnum);
      }
      else if (newnum.match(p1)){
         newnum = usNumber.substring(1,4)+usNumber.substring(5,8)+usNumber.substring(9,12);
         $('#'+id).attr('value', newnum);
      }
      else if (newnum.match(p2)){
